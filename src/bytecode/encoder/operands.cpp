...
template<class Value, class Class>
static auto fetch_primitive_value(viua::internals::types::byte* ip, viua::process::Process* p, Value initial)
    -> tuple<viua::internals::types::byte*, Value> {
...
auto viua::bytecode::decoder::operands::fetch_register_index(viua::internals::types::byte* ip,
    ...
    -> tuple<viua::internals::types::byte*, unsigned> {
    OperandType ot = get_operand_type(ip);
    ++ip;
...
auto viua::bytecode::decoder::operands::fetch_primitive_int(viua::internals::types::byte* ip,
    ...
    -> tuple<viua::internals::types::byte*, int> {
...
auto viua::bytecode::decoder::operands::fetch_raw_float(viua::internals::types::byte* ip,
                                                        viua::process::Process*)
    -> tuple<viua::internals::types::byte*, float> {
...
auto viua::bytecode::decoder::operands::fetch_object(viua::internals::types::byte* ip,
                                                     viua::process::Process* p)
    -> tuple<viua::internals::types::byte*, Type*> {
    unsigned register_index = 0;
