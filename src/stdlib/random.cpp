...
void random_drandom(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
...
void random_durandom(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
    /** Return random integer.
     *
...
void random_random(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
    /** Return random float from range between 0.0 and 1.0.
     */
    frame->regset->set(0, new viua::types::Float(getrandom()));
}

void random_randint(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
