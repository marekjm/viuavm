...
// foreign methods
void String::stringify(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
...
void String::represent(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
    if (frame->args->size() < 2) {
        throw new viua::types::Exception("expected 2 parameters");
    }
...
void String::startswith(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
...
void String::endswith(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
    string s = static_cast<String*>(frame->args->at(1))->value();
...
void String::format(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
...
void String::substr(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
    int begin = 0;
    int end = -1;
...
void String::concatenate(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
    frame->regset->set(0, new String(static_cast<String*>(frame->args->at(0))->value() + static_cast<String*>(frame->args->at(1))->value()));
}

void String::join(Frame*, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
    // TODO: implement
}

void String::size(Frame* frame, RegisterSet*, RegisterSet*, Process*, viua::kernel::Kernel*) {
