...
.label main
    ...
    li $1.l, -1
    li $2.l, -1
    add.saturate $15.l, $1.l, $2.l

    ; -one # max
    li $1.l, -1
    li $2.l, 127
    add.saturate $16.l, $1.l, $2.l

    ; -one # min
    li $1.l, -1
    li $2.l, -128
    add.saturate $17.l, $1.l, $2.l
    ...
    li $1.l, 127
    li $2.l, 0
    add.saturate $18.l, $1.l, $2.l

    ; max # one
    li $1.l, 127
    li $2.l, 1
    add.saturate $19.l, $1.l, $2.l

    ; max # -one
    li $1.l, 127
    li $2.l, -1
    add.saturate $20.l, $1.l, $2.l

    ; max # max
    li $1.l, 127
    li $2.l, 127
    add.saturate $21.l, $1.l, $2.l

    ; max # min
    li $1.l, 127
    li $2.l, -128
    add.saturate $22.l, $1.l, $2.l
    ...
    li $1.l, -128
    li $2.l, 0
    add.saturate $23.l, $1.l, $2.l

    ; min # one
    li $1.l, -128
    li $2.l, 1
    add.saturate $24.l, $1.l, $2.l

    ; min # -one
    li $1.l, -128
    li $2.l, -1
    add.saturate $25.l, $1.l, $2.l

    ; min # max
    li $1.l, -128
    li $2.l, 127
    add.saturate $26.l, $1.l, $2.l

    ; min # min
    li $1.l, -128
    li $2.l, -128
    add.saturate $27.l, $1.l, $2.l
