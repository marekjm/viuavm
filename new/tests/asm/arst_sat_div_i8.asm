...
.label main
    ...
    li $1.l, -1
    li $2.l, 0
    div.saturate $13.l, $1.l, $2.l

    ; -one # one
    li $1.l, -1
    li $2.l, 1
    div.saturate $14.l, $1.l, $2.l

    ; -one # -one
    li $1.l, -1
    li $2.l, -1
    div.saturate $15.l, $1.l, $2.l

    ; -one # max
    li $1.l, -1
    li $2.l, 127
    div.saturate $16.l, $1.l, $2.l

    ; -one # min
    li $1.l, -1
    li $2.l, -128
    div.saturate $17.l, $1.l, $2.l
    ...
    li $1.l, 127
    li $2.l, 0
    div.saturate $18.l, $1.l, $2.l

    ; max # one
    li $1.l, 127
    li $2.l, 1
    div.saturate $19.l, $1.l, $2.l

    ; max # -one
    li $1.l, 127
    li $2.l, -1
    div.saturate $20.l, $1.l, $2.l

    ; max # max
    li $1.l, 127
    li $2.l, 127
    div.saturate $21.l, $1.l, $2.l

    ; max # min
    li $1.l, 127
    li $2.l, -128
    div.saturate $22.l, $1.l, $2.l
    ...
    li $1.l, -128
    li $2.l, 0
    div.saturate $23.l, $1.l, $2.l

    ; min # one
    li $1.l, -128
    li $2.l, 1
    div.saturate $24.l, $1.l, $2.l

    ; min # -one
    li $1.l, -128
    li $2.l, -1
    div.saturate $25.l, $1.l, $2.l

    ; min # max
    li $1.l, -128
    li $2.l, 127
    div.saturate $26.l, $1.l, $2.l

    ; min # min
    li $1.l, -128
    li $2.l, -128
    div.saturate $27.l, $1.l, $2.l
