...
.label main
    ...
    li $1.l, -1
    li $2.l, -1
    sub.wrap $15.l, $1.l, $2.l

    ; -one # max
    li $1.l, -1
    li $2.l, 127
    sub.wrap $16.l, $1.l, $2.l

    ; -one # min
    li $1.l, -1
    li $2.l, -128
    sub.wrap $17.l, $1.l, $2.l
    ...
    li $1.l, 127
    li $2.l, 0
    sub.wrap $18.l, $1.l, $2.l

    ; max # one
    li $1.l, 127
    li $2.l, 1
    sub.wrap $19.l, $1.l, $2.l

    ; max # -one
    li $1.l, 127
    li $2.l, -1
    sub.wrap $20.l, $1.l, $2.l

    ; max # max
    li $1.l, 127
    li $2.l, 127
    sub.wrap $21.l, $1.l, $2.l

    ; max # min
    li $1.l, 127
    li $2.l, -128
    sub.wrap $22.l, $1.l, $2.l
    ...
    li $1.l, -128
    li $2.l, 0
    sub.wrap $23.l, $1.l, $2.l

    ; min # one
    li $1.l, -128
    li $2.l, 1
    sub.wrap $24.l, $1.l, $2.l

    ; min # -one
    li $1.l, -128
    li $2.l, -1
    sub.wrap $25.l, $1.l, $2.l

    ; min # max
    li $1.l, -128
    li $2.l, 127
    sub.wrap $26.l, $1.l, $2.l

    ; min # min
    li $1.l, -128
    li $2.l, -128
    sub.wrap $27.l, $1.l, $2.l
