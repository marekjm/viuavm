...
int generate(const std::vector<std::string>&, std::vector<std::string>&, invocables_t&, invocables_t&, std::string&, std::string&, const std::vector<std::string>&, const compilationflags_t&);
